			  	...
			  	<div class="itemrow">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$location.'" placeholder="e.g: Binodpur, Rajshahi">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="Varendro Univesity">Varendro Univesity</option>
							  <option value="Brac University">Brac University</option>
							  <option value="Dhaka Univesity">Dhaka Univesity</option>
							  <option value="Rajshahi Univesity">Rajshahi Univesity</option>
					...
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 26/2/2023" value="'.$deadline.'">'; ?></p>
				  			</div>
				  	</div>

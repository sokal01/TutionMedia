			  	...
			  	<form action="#" method="post">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Binodpur, Rajshahi">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
					...
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 26/2/2023" value="'.$f_dead.'">'; ?></p>
				  			</div>
				  		</div>
